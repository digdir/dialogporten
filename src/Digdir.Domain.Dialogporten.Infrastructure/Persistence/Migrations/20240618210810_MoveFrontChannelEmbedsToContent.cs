    ...
    public partial class MoveFrontChannelEmbedsToContent : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                column: "AllowedMediaTypes",
                value: new List<string> { "text/html", "text/plain", "text/markdown" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 6, new List<string> { "application/vnd.dialogporten.frontchannelembed+json;type=markdown" }, 1023, "MainContentReference", false, false });
        }
