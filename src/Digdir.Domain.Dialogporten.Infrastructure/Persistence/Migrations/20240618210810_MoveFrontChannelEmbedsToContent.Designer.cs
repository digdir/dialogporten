...
namespace Digdir.Domain.Dialogporten.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240618210810_MoveFrontChannelEmbedsToContent")]
            ...
            modelBuilder.Entity("Digdir.Domain.Dialogporten.Domain.Dialogs.Entities.Content.DialogContentType", b =>
                {
                    ...
                    b.Property<List<string>>("AllowedMediaTypes")
                        .HasColumnType("text[]");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            AllowedMediaTypes = new List<string> { "text/html", "text/plain", "text/markdown" },
                            MaxLength = 1023,
                            Name = "AdditionalInfo",
                            OutputInList = false,
                            Required = false
                        ...
                        {
                            Id = 6,
                            AllowedMediaTypes = new List<string> { "application/vnd.dialogporten.frontchannelembed+json;type=markdown" },
                            MaxLength = 1023,
