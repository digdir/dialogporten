...
internal sealed class DialogDbContext : DbContext, IDialogDbContext
{
    ...
    public DbSet<DialogDialogActivity> DialogActivities => Set<DialogDialogActivity>();
    public DbSet<DialogDialogActivityType> DialogActivityTypes => Set<DialogDialogActivityType>();
