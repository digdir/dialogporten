...
public static class DialogGenerator
{
    ...
    public static ActivityDto GenerateFakeDialogActivity(DialogDialogActivityType.Values? type = null)
    ...
    public static List<ActivityDto> GenerateFakeDialogActivities(int? count = null, DialogDialogActivityType.Values? type = null)
    {
        ...
        var activityTypes = Enum.GetValues<DialogDialogActivityType.Values>()
            .Where(x => x != DialogDialogActivityType.Values.TransmissionOpened).ToList();
        ...
        return new Faker<ActivityDto>()
            ...
            .RuleFor(o => o.Description, (f, o) => o.Type == DialogDialogActivityType.Values.Information ? GenerateFakeLocalizations(f.Random.Number(4, 8)) : null)
            .Generate(count ?? new Randomizer().Number(1, 4));
    }
