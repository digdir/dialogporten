export default function (endUser, resource) {
    return {
        "serviceResource": "urn:altinn:resource:" +resource, // urn starting with urn:altinn:resource:
        ...
        "searchTags": [
            ...
            { "value": "Created by performancetest" } // Do not remove this, this is used to look for unpurged dialogs after a run
        ],
        "content": {
            "Title": {
